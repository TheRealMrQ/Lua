...
information:CreateButton("Discord Invite", function() setclipboard("about:plugins") end)
...
farmsettings:CreateTextBox("Autofarming Walkspeed", "Default Value = 77", true, function(Value) kocmoc.vars.farmspeed = Value end)
